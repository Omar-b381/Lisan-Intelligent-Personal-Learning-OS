...
- **قفل الذاكرة وعدم التكرار (Memory Lock & History Tracking)**: ميزة ذكية تحفظ سجل التدريب وتستبعد تلقائياً الكلمات التي تم إتقانها مسبقاً للتركيز على الكلمات الجديدة أو التي تحتاج إلى تثبيت.
- **نظام التلميح الذكي المخفي (`💡 Hint Toggle`)**: إخفاء معنى البطاقة والإجابة تحت زر تفاعلي لتجنب حرق الحل، مع إمكانية كشفه كتلميح عند الحاجة.
- **قراءة صوتية متكاملة للأسئلة والخيارات (Question-Level TTS)**: زر صوتي بارز لقراءة نص السؤال بالكامل، مع إمكانية نطق أي خيار من الخيارات (A, B, C, D) بضغطة زر.
- **دعم أشهر نماذج ومزودي الذكاء الاصطناعي**: OpenAI (GPT-4o/mini, o3-mini)، Anthropic (Claude 3.5 Sonnet/Haiku)، Google Gemini (1.5/2.0 Flash)، DeepSeek (V3/R1)، Groq (Llama 3.3)، وخوادم **Ollama** و **LM Studio** المحلية.
